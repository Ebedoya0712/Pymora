            ...
            <div class="p-4 space-y-6">
                ...
                <nav class="space-y-1 text-sm font-medium">
                    ...
                    @if($showTenantModules)
                        ...
                        <a href="{{ route('scanner.index') }}" class="flex items-center gap-3 px-3 py-2 rounded-lg transition-colors {{ request()->routeIs('scanner.index') ? 'bg-indigo-600/20 text-indigo-400 border border-indigo-500/30 font-semibold' : 'text-slate-400 hover:bg-slate-800 hover:text-slate-200' }}">
