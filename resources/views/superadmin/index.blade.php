...
<div class="space-y-6">
    ...
    <div class="flex flex-col md:flex-row items-start md:items-center justify-between gap-4 bg-slate-900/60 p-6 rounded-2xl border border-slate-800 backdrop-blur-xl">
        ...
        <div class="flex items-center gap-2">
            <a href="{{ route('superadmin.empresas') }}" class="bg-indigo-600 hover:bg-indigo-500 text-white font-bold text-xs px-4 py-2.5 rounded-xl shadow-lg shadow-indigo-600/20 transition-all flex items-center gap-2">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <!-- 4. Período de Trial -->
        <a href="{{ route('superadmin.configuracion') }}" class="glass-card p-5 rounded-2xl border border-slate-800 hover:border-purple-500/40 transition-all group">
            <div class="flex items-center justify-between text-slate-400 text-xs font-medium mb-1">
            ...
            <div class="text-3xl font-black text-purple-400 font-mono">{{ $trialDays }} <span class="text-xs text-slate-400 font-normal">Días</span></div>
            <div class="text-xs text-purple-400/80 font-semibold mt-2 flex items-center justify-between">
                <span>Período Trial Inicial</span>
                <span class="group-hover:translate-x-1 transition-transform">&rarr;</span>
            </div>
        </a>
    </div>
